...
* `DevelopmentGroup: [String]` DevelopmentGroup is a group of people which allows you to show or hide some data products from the people belonging to the specific group
